...
```text
使用 数据集标准调研 调研【目标领域】高质量数据集相关文件。快速测试：只找 5 个官方文件，不下载 PDF。严格使用固定表头，官方链接必须是具体网页，不使用门户首页或搜索首页；标准销售、交易、购买、付费在线阅读等商业服务网站一律排除。并在最后写一段 100 字左右总结。
```
...
```text
使用 数据集标准调研 调研农业高质量数据集相关文件。快速测试：只找 10 个官方文件，不下载 PDF。必须包含顶层设计与政策框架、高质量数据集专项文件、农业专项文件三类。严格使用固定表头，优先中文检索，官方链接必须是具体网页，不使用门户首页或搜索首页；标准类文件优先使用标准主管平台的具体标准页，并排除标准销售、交易、购买、付费在线阅读等商业服务网站。最后从完整清单中推荐 5-8 个重点阅读文件。
```

```text
使用 数据集标准调研 调研医疗领域高质量数据集相关政策、标准、指南和典型案例。输出固定表头表格，官方链接必须是具体网页，不使用门户首页或搜索首页；标准类文件优先使用标准主管平台的具体标准页，并排除标准销售、交易、购买、付费在线阅读等商业服务网站。并说明医疗领域与农业领域在数据采集、标注、质量控制和合规方面的差异。
```
...
```text
使用 数据集标准调研 调研能源行业高质量数据集相关文件。要求覆盖顶层政策、行业标准、数据安全和典型案例；只使用具体官方网页链接，不使用门户首页或搜索首页，不直接给 PDF 链接；标准销售、交易、购买、付费在线阅读等商业服务网站一律排除；最后总结能源行业与农业行业在采集、标注和合规方面的差异。
```
